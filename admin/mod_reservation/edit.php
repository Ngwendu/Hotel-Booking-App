...
<form class="form-horizontal" action="" method="post" onsubmit="return personalInfo()" name="personal">
    ...
    <section class="content">
        ...
        FROM  `tblreservation` WHERE  `CONFIRMATIONCODE` = '" . $code . "'";
                            ...
                            <div class="form-group">
                                <div class="col-md-10">
                                    <label class="col-md-4 control-label" for="TRANSDATE">Transaction Date:</label>
                                    <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <div class="col-md-10">
                                    <label class="col-md-4 control-label" for="CONFIRMATIONCODE">Confirmation Code:</label>
