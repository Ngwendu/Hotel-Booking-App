    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-md-8">
                ...
                <div class="col-md-8">
                    ...
                    <input class="form-control input-sm" id="ACCOMODATION" name="ACCOMODATION" placeholder="Account Name" type="text" value="<?php echo $result->ACCOMODATION; ?>">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-8">
                ...
                <div class="col-md-8">
                    <input class="form-control input-sm" id="ACCOMDESC" name="ACCOMDESC" placeholder="Description" type="text" value="<?php echo $result->ACCOMDESC; ?>">
                </div>
            </div>
        </div>
